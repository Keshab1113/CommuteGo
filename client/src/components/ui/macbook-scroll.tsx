...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="md:min-h-[200vh] min-h-screen  flex flex-col items-center py-0 md:py-40 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100 scale-[0.35] sm:scale-50"
    >
      ...
      <div className=' absolute h-full flex flex-col justify-center items-center w-full overflow-hidden'>
        ...
        >
          <h1 className=' leading-normal text-xl md:text-2xl'>Best Way To Start Your Journey!</h1>
        </div>
      </div>
      {/* Base area */}
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      >
        <div
          style={{
            boxShadow: "0px 2px var(--neutral-900) inset",
          }}
      ...
      >
        ...
        <video
          ...
          autoPlay
          loop
          className="object-cover absolute rounded-lg inset-0 h-full w-full object-center"
        />
      </motion.div>
    </div>
  );
...
const AceternityLogo = () => {
  return (
    ...
    >
      <path
        d="M8 8.05571C8 8.05571 54.9009 18.1782 57.8687 30.062C60.8365 41.9458 9.05432 57.4696"
        stroke="currentColor"
        strokeWidth="15"
