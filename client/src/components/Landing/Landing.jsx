...
const Landing = () => {
    return (
        <div className="h-screen w-full rounded-md flex md:items-center md:justify-center bg-black/[0.96] antialiased bg-grid-white/[0.02] relative overflow-hidden">
            ...
            <div className=" absolute h-[24rem]  md:mt-0 lg:mt-12  xl:mt-[100px] 2xl:mt-[240px] flex items-center justify-center max-sm:[mask-image:radial-gradient(90%_50%,white,transparent)] bottom-0">
